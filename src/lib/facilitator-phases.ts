...
const ARC42_WORKSHOP_PHASES: FacilitatorPhase[] = [
  ...
  },
  {
    ...
    description: "ADRs, Qualität und technische Schulden festhalten.",
    allowedTypes: ["archBlackbox", "note", "hotspot", "link"],
    checklist: [
      "Architekturentscheidungen als Notizen/Links",
      "Qualitätsanforderungen und Risiken (Hotspots)",
      "Glossar-Panel parallel pflegen",
    ],
    durationMinutes: 30,
  },
];

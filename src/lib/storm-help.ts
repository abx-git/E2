...
const ELEMENT_HELP: Record<ElementType, HelpDialogModel> = {
  ...
  c4Person: {
    title: "Person",
    subtitle: "C4 Level 1 — Nutzer / Akteur",
    paragraphs: [
      "Mensch (Rolle, Persona), der mit Software-Systemen interagiert.",
      "Im Kontextdiagramm um das zentrale System herum platzieren — Technologie ist hier unwichtig.",
    ],
    bullets: [
      "Nur Personen und Software-Systeme auf Level 1",
      "Beziehungen beschriften (z. B. „nutzt“, „sendet E-Mails an“)",
      "Geeignet für technische und nicht-technische Zielgruppen",
    ],
  },
  c4SoftwareSystem: {
    title: "Software-System",
    subtitle: "C4 Level 1 — Blackbox im Kontext",
    paragraphs: [
      "Höchste Abstraktion: das System als geschlossene Box im Gesamtkontext.",
      "Über „Detail-Sicht“ zoomst du hinein — analog C4 Container-Diagramm (wie Blackbox → Whitebox).",
    ],
    bullets: [
      "Zentrales System klar benennen; externe Systeme abgrenzen",
      "Detail-Sicht öffnen → Container darin modellieren",
      "Nicht alle Zoom-Ebenen nötig — Kontext + Container reichen oft",
    ],
  },
  c4Container: {
    title: "Container",
    subtitle: "C4 Level 2 — Anwendung / Datenspeicher",
    paragraphs: [
      "Deploybare Einheit innerhalb eines Systems: Web-App, SPA, API, Datenbank, Queue, …",
      "Zeigt die grobe technische Form und Verantwortlichkeiten. Zoom in für Komponenten.",
    ],
    bullets: [
      "Technologie / Protokoll angeben (z. B. Spring Boot, PostgreSQL)",
      "Kommunikation zwischen Containern mit Relationen beschriften",
      "Detail-Sicht öffnen → Komponenten-Diagramm (Level 3)",
    ],
  },
  c4Component: {
    title: "C4 Komponente",
    subtitle: "C4 Level 3 — Baustein im Container",
    paragraphs: [
      "Logischer Baustein innerhalb eines Containers (Controller, Service, Adapter, …).",
      "Nur anlegen, wenn der Zoom Mehrwert bringt — oft automatisierbar oder optional.",
    ],
    bullets: [
      "Verantwortung kurz in der Beschreibung",
      "Technologie optional",
      "Schnittstellen über Relationen",
    ],
  },
  archBlackbox: {
    title: "Blackbox",
    subtitle: "Geschlossener Baustein — C4-ähnlicher Zoom",
    paragraphs: [
      "Baustein von außen: Name, Verantwortung und Schnittstellen — Innenleben verborgen.",
      "Funktionsweise wie bei C4: „Detail-Sicht“ = Zoom in → Whitebox mit inneren Bausteinen (Container-/Komponenten-Ebene).",
    ],
    bullets: [
      "Kontext: Blackboxes + Person / Software-System",
      "Detail-Sicht öffnen für Whitebox-Drill-down",
      "Verschachteln: Whitebox kann wieder Blackboxes enthalten",
    ],
  },
  archWhitebox: {
    title: "Whitebox",
    subtitle: "Geöffneter Baustein — Scope nach Zoom-in",
    paragraphs: [
      "Geöffneter Baustein / gestrichelter Scope (wie die System- oder Container-Grenze im C4-Diagramm).",
      "Zeigt innere Komponenten und Beziehungen; entsteht typischerweise als Detail-Sicht einer Blackbox oder eines C4-Systems/Containers.",
    ],
    bullets: [
      "Innere Blackboxes, Container oder Komponenten platzieren",
      "Selbst wieder drillbar für tiefere Zoom-Ebenen",
      "Zurück zur Übersicht über Detail-Navigation",
    ],
  },
  archComponent: {
    title: "Komponente",
    subtitle: "Baustein-Blatt — analog C4 Level 3",
    paragraphs: [
      "Feiner Baustein innerhalb einer Whitebox (Modul, Service, Adapter, …).",
      "Entspricht der Komponenten-Ebene im C4-Modell.",
    ],
    bullets: [
      "Technologie optional in der Beschreibung",
      "Relationen zu Schnittstellen und Nachbarn",
